...
os.environ["OPENAI_API_KEY"] = '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'
...
def chat_with_user():
    ...
    opening_line = "Hello, I'm calling from Aryantech Motors regarding our newly launched car. Are you interested in purchasing a new car at the moment?"
    print(opening_line)
